...
/**
 * Detect if the current Clica instance is running as a CLI subagent.
 ...
 *     unless users pass in "-s max_consecutive_mistakes=6" via Clica CLI. Would like better detection.
