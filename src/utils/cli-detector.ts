...
/**
 * Detect if the current Clino instance is running as a CLI subagent.
 ...
 *     unless users pass in "-s max_consecutive_mistakes=6" via Clino CLI. Would like better detection.
