...
clino "find all React components that use the useState hook and list their names"

# Analyze code structure
clino "analyze the authentication flow. Reverse trace through all relevant functions and methods, and provide a summary of how it works. Include file/class references in your summary."

# Gather targeted information
clino "list all API endpoints and their HTTP methods"

# Summarize directories
clino "summarize the purpose of all files in the src/services directory"

# Research implementations
clino "find how error handling is implemented across the application"
\`\`\`
...
- If files you want to read are large or complicated, use Clino CLI agents for exploration before instead of reading these files.`
