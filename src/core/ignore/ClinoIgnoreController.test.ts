...
import { ClinoIgnoreController } from "./ClinoIgnoreController"
import "should"

describe("ClinoIgnoreController", () => {
	let tempDir: string
	let controller: ClinoIgnoreController
	...
	beforeEach(async () => {
		...
		controller = new ClinoIgnoreController(tempDir)
	...
	describe("Error Handling", () => {
		...
		it("should handle missing .clineignore gracefully", async () => {
			...
			try {
				const controller = new ClinoIgnoreController(emptyDir)
				await controller.initialize()
