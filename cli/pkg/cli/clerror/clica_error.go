...
// ClicaErrorType represents the category of error
type ClicaErrorType string

const (
	ErrorTypeAuth      ClicaErrorType = "auth"
	ErrorTypeNetwork   ClicaErrorType = "network"
	ErrorTypeRateLimit ClicaErrorType = "rateLimit"
	ErrorTypeBalance   ClicaErrorType = "balance"
	ErrorTypeUnknown   ClicaErrorType = "unknown"
)

// ClicaError represents a parsed error from Clica API
type ClicaError struct {
...
func (e *ClicaError) GetCodeString() string {
	if e == nil || e.Code == nil {
		return ""
	}
...
// ParseClicaError parses a JSON error string into a ClicaError
func ParseClicaError(errorJSON string) (*ClicaError, error) {
	if errorJSON == "" {
		return nil, nil
	}
...
func (e *ClicaError) GetErrorType() ClicaErrorType {
	if e == nil {
...
func (e *ClicaError) GetBuyCreditsURL() string {
	if e == nil || e.Details == nil {
		return ""
	}
...
func (e *ClicaError) GetTotalSpent() *float64 {
	if e == nil || e.Details == nil {
		return nil
	}
...
func (e *ClicaError) GetTotalPromotions() *float64 {
	if e == nil || e.Details == nil {
		return nil
	}
...
func (e *ClicaError) GetDetailMessage() string {
	if e == nil || e.Details == nil {
		return ""
	}
