...
// ClinoErrorType represents the category of error
type ClinoErrorType string

const (
	ErrorTypeAuth      ClinoErrorType = "auth"
	ErrorTypeNetwork   ClinoErrorType = "network"
	ErrorTypeRateLimit ClinoErrorType = "rateLimit"
	ErrorTypeBalance   ClinoErrorType = "balance"
	ErrorTypeUnknown   ClinoErrorType = "unknown"
)

// ClinoError represents a parsed error from Clino API
type ClinoError struct {
...
func (e *ClinoError) GetCodeString() string {
	if e == nil || e.Code == nil {
		return ""
	}
...
// ParseClinoError parses a JSON error string into a ClinoError
func ParseClinoError(errorJSON string) (*ClinoError, error) {
	if errorJSON == "" {
		return nil, nil
	}
...
func (e *ClinoError) GetErrorType() ClinoErrorType {
	if e == nil {
...
func (e *ClinoError) GetBuyCreditsURL() string {
	if e == nil || e.Details == nil {
		return ""
	}
...
func (e *ClinoError) GetTotalSpent() *float64 {
	if e == nil || e.Details == nil {
		return nil
	}
...
func (e *ClinoError) GetTotalPromotions() *float64 {
	if e == nil || e.Details == nil {
		return nil
	}
...
func (e *ClinoError) GetDetailMessage() string {
	if e == nil || e.Details == nil {
		return ""
	}
