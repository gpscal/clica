...
# This installs the clica-core app to the user's home directory,
...
LOG_FILE=~/.clica/clica-core-service.log
...
echo pwd: $(pwd)
set -x
NODE_PATH=$BINARY_MODULES_DIR:./node_modules DEV_WORKSPACE_FOLDER=/tmp/ node clica-core.js 2>&1 | tee $LOG_FILE
