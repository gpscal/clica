...
# This installs the clino-core app to the user's home directory,
...
LOG_FILE=~/.clino/clino-core-service.log
...
echo pwd: $(pwd)
set -x
NODE_PATH=$BINARY_MODULES_DIR:./node_modules DEV_WORKSPACE_FOLDER=/tmp/ node clino-core.js 2>&1 | tee $LOG_FILE
